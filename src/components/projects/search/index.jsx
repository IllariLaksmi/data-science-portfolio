...
const ProjectSearch = () => {
    ...
    return (<div className="flex flex-col justify-center items-center mt-4  m-4 w-100">
                ...
                <div className="flex flex-col flex-wrap md:flex-row justify-center md:justify-around w-full columns-4 md:columns-3 gap-2 scrollbar-hide ">
